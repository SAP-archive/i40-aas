...
let CORE_INGRESS_HTTP_USER: string | undefined =
  process.env.CORE_INGRESS_HTTP_USER;
let CORE_INGRESS_HTTP_PASSWORD: string | undefined =
  process.env.CORE_INGRESS_HTTP_PASSWORD;
