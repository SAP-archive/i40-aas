...
echo "host: $ENDPOINT_REGISTRY_ENDPOINT_REGISTRY_POSTGRES_HOST"
echo "port: $ENDPOINT_REGISTRY_ENDPOINT_REGISTRY_POSTGRES_PORT"
echo "db: $ENDPOINT_REGISTRY_ENDPOINT_REGISTRY_POSTGRES_DB"
echo "user: $ENDPOINT_REGISTRY_ENDPOINT_REGISTRY_POSTGRES_USER"
