...
import { IRegistryResultSet, Protocols, IEndpoint, Endpoint, RegistryResultSet } from '../interfaces/IRegistryResultSet';
...
import { IRegisterAas } from '../interfaces/IApiRequests';
class Registry implements iRegistry {
  ...
  createSemanticProtocol(req: import('../interfaces/IApiRequests').ICreateSemanticProtocol): void {
    throw new Error('Method not implemented.');
  }
  registerRoles(req: import('../interfaces/IApiRequests').IRegisterRoles): void {
    throw new Error('Method not implemented.');
  }
